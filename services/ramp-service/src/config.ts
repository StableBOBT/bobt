...
export const stellarConfig = {
  ...
  oracleContract: process.env.ORACLE_CONTRACT_ID ||
    'CAIVJPXLLIJVSSO67Z4V44B2JHYK323GWRG7OCA7IE7DL3IUZC6JL7Q7',
  tokenContract: process.env.TOKEN_CONTRACT_ID ||
    'CBFNIREQSJR7EM5QXALVV6JUY3BTYP2G5VRPKB2UIXUJRSUW2TIJHD55',
  treasuryContract: process.env.TREASURY_CONTRACT_ID ||
    'CAAXLHDBYDBQLSPBMW4OF42UGBGT6DU5HM2BWZXUVTAIQYPGU74PSJS5',
